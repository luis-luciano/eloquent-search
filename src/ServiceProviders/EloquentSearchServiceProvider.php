...
namespace EloquentSearch\EloquentSearch\ServiceProviders;

use EloquentSearch\EloquentSearch\Contracts\SampleInterface;
use EloquentSearch\EloquentSearch\Facades\SampleFacadeAccessor;
use EloquentSearch\EloquentSearch\Sample;
use Illuminate\Support\ServiceProvider;

/**
 * Class EloquentSearchServiceProvider
 *
